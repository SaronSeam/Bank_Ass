    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
							<h3 class="app-page-title mb-0">Income</h3>
				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    <div class="col-auto">
								    <form id="in" class="table-search-form row gx-1 align-items-center" class="d-flex justify-content-center">
									<div class="col-auto">
					    ...
					    <div class="app-card app-card-orders-table shadow-sm mb-5">
						    <div class="app-card-body">
							    <div class="table-responsive">
									<table class="table mb-0 text-left" id="tbl_income">
										<thead>
											<tr>
            ...
            headers: {
					...
					if(confirm("Want to clear?")){
					  ...
					  $("#btnsave").click(function(){
						...
						///alert(bank +""+date);
						$.post('setincome',{bank:bank,amount:amount,des:des,date:date} ,function(result){
							alert("Success");
					  ...
					  $("#tbl_income").on("click","#edit",function(){
						...
						//	alert(id);
							...
							var newdes = $("#newdes").val();
							var newdate = $("#newdate").val();

							

							$.post("updatein",{id:id,newbank:newbank,newamount:newamount,newdes:newdes,newdate:newdate},function(result){
									alert(result);
									window.location.href="income";
					  ...
					  $("#tbl_income").on("click","#delete",function(){
    					...
    					var id = current_row.find('th').eq(0).text();
							...
							$("#ok").click(function(){
								$.post("deletein",{id:id},function(result){
									alert(result);
									window.location.href="income";
							})
